...
function buildCsp(nonce: string) {
  ...
  return [
    `default-src 'self'`,
    // strict-dynamic confía en scripts inyectados por scripts con nonce (cubre Turnstile y Stripe.js).
    ...
    // img-src: dominios conocidos + Stripe (logos de tarjetas en Stripe Elements).
