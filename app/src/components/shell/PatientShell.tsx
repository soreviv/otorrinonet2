    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950">
      ...
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-6">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-sky-600 dark:bg-sky-500 flex items-center justify-center shadow-sm group-hover:bg-sky-700 dark:group-hover:bg-sky-400 transition-colors">
            ...
            {navigationItems.map((item) => (
              <button
                ...
                className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  item.isActive
                    ? 'text-sky-700 dark:text-sky-400 bg-sky-50 dark:bg-sky-950'
          ...
          <div className="hidden md:flex items-center gap-3 ml-auto">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-sky-600 hover:bg-sky-700 dark:bg-sky-500 dark:hover:bg-sky-400 text-white text-sm font-semibold transition-colors shadow-sm"
            >
              Agendar Cita
            </button>
