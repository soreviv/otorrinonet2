  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 flex flex-col items-end gap-1">
        ...
        <svg className="w-4 h-4 text-slate-300 dark:text-slate-600 group-hover:text-sky-500 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
...
function SurgicalNoteRow({ note, onView }: { note: SurgicalNote; onView?: () => void }) {
  ...
  return (
    ...
    >
      ...
      <svg className="flex-shrink-0 w-4 h-4 text-slate-300 dark:text-slate-600 group-hover:text-sky-500 transition-colors self-center" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
        <path d="M9 18l6-6-6-6" />
      </svg>
    </button>
  )
