...
import type { DoctorProfilePageProps } from '../types'
    ...
    <div className="min-h-screen bg-slate-50 font-sans antialiased dark:bg-slate-950">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-40 h-40 md:w-52 md:h-52 rounded-3xl overflow-hidden bg-gradient-to-br from-teal-400 to-teal-700 shadow-xl">
                {!imgError && (
                  <img
              ...
              {/* Verified badge */}
              <div className="absolute -bottom-2 -right-2 bg-teal-600 rounded-full p-1.5 shadow-lg">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 bg-teal-50 dark:bg-teal-950 text-teal-700 dark:text-teal-300 text-xs font-bold px-3 py-1.5 rounded-full border border-teal-100 dark:border-teal-800 mb-4">
              ...
              <p className="text-lg text-teal-600 dark:text-teal-400 font-semibold mt-1">{doctorProfile.title}</p>
              ...
              <button
                onClick={onBookAppointment}
                className="mt-6 inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold px-6 py-3 rounded-xl transition-all hover:shadow-lg hover:shadow-teal-200 dark:hover:shadow-teal-900 active:scale-[0.98] text-sm"
              >
                <Calendar className="w-4 h-4" />
                Agendar Consulta
              </button>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="relative pl-6">
                {/* Vertical line */}
                <div className="absolute left-[7px] top-2 bottom-2 w-px bg-gradient-to-b from-teal-300 via-teal-200 to-transparent dark:from-teal-700 dark:via-teal-800" />

                <div className="flex flex-col gap-7">
                  {doctorProfile.education.map((entry, i) => (
                    <div key={i} className="relative">
                      {/* Dot */}
                      <div className="absolute -left-6 top-1.5 w-3.5 h-3.5 rounded-full bg-teal-600 dark:bg-teal-500 border-2 border-white dark:border-slate-950 shadow-sm" />
                      <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-4 hover:border-teal-200 dark:hover:border-teal-800 transition-colors">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <span className="text-xs font-bold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950 px-2.5 py-1 rounded-lg flex-shrink-0">
                            {entry.year}
                          </span>
                        </div>
                      </div>
          ...
          {/* Right: Certifications + Hospitals + CTA */}
          <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                {doctorProfile.certifications.map((cert, i) => (
                  <div key={i} className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-teal-50 dark:bg-teal-950 border border-teal-200 dark:border-teal-800 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <BadgeCheck className="w-3 h-3 text-teal-600 dark:text-teal-400" />
                    </div>
              ...
              <div className="flex flex-col gap-3">
                {doctorProfile.hospitals.map((hospital, i) => (
                  <div key={i} className="flex items-center gap-2.5">
                    <div className="w-1.5 h-1.5 rounded-full bg-teal-400 dark:bg-teal-500 flex-shrink-0" />
            ...
            {/* Sidebar CTA */}
            <div className="relative overflow-hidden bg-teal-600 rounded-2xl p-6 text-center">
              <div
              ...
              <div className="relative">
                <p className="text-xs font-bold text-teal-100 uppercase tracking-widest mb-2">Agenda tu consulta</p>
                <p className="text-sm text-teal-50 mb-4 leading-relaxed">
                  Atención personalizada para ti y tu familia.
                </p>
                <button
                  onClick={onBookAppointment}
                  className="w-full flex items-center justify-center gap-2 bg-white text-teal-700 font-bold px-5 py-3 rounded-xl text-sm hover:bg-teal-50 transition-colors active:scale-[0.98]"
                >
                  <Calendar className="w-4 h-4" />
                  Agendar Cita
                </button>
