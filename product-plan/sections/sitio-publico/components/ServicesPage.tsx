...
import type { ServicesPageProps, ServiceIcon } from '../types'
...
const ACCENTS = [
  'bg-teal-50 dark:bg-teal-950 text-teal-600 dark:text-teal-400 border-teal-100 dark:border-teal-900',
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans antialiased dark:bg-slate-950">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((service, i) => {
            ...
            return (
              <div
                key={service.id}
                className="group flex flex-col gap-4 p-6 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl hover:border-teal-200 dark:hover:border-teal-800 hover:shadow-lg hover:shadow-teal-50/60 dark:hover:shadow-teal-950/60 transition-all duration-300"
              >
                {/* Icon */}
                ...
                <button
                  onClick={onBookAppointment}
                  className="mt-1 flex items-center gap-1.5 text-xs font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors group/btn"
                >
                  Agendar consulta
        ...
        {/* Bottom CTA banner */}
        <div className="mt-12 relative overflow-hidden bg-teal-600 rounded-2xl p-8 md:p-10 text-center">
          <div
          ...
          <div className="relative">
            <p className="text-[11px] font-bold text-teal-100 uppercase tracking-widest mb-3">Primera consulta disponible esta semana</p>
            ...
            <button
              onClick={onBookAppointment}
              className="inline-flex items-center gap-2 bg-white text-teal-700 font-bold px-7 py-3.5 rounded-xl transition-all hover:bg-teal-50 hover:shadow-xl active:scale-[0.98] text-sm"
            >
              <Calendar className="w-4 h-4" />
