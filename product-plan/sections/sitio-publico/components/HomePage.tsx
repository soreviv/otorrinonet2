...
import type { HomePageProps, GoogleRatingSummary } from '../types'
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans antialiased dark:bg-slate-950">
            ...
            <div className="hidden md:flex items-center gap-7">
              {NAV_LINKS.map(({ label, href }) => (
                <a
                  key={label}
                  href={href}
                  className="text-sm text-slate-500 hover:text-teal-600 font-medium transition-colors dark:text-slate-400 dark:hover:text-teal-400"
                >
                  {label}
                </a>
              ))}
      ...
      <section className="relative overflow-hidden bg-white dark:bg-slate-900">
        <div
          className="absolute top-0 right-0 h-full w-[55%] bg-gradient-to-bl from-teal-600 to-teal-700 hidden md:block"
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-28">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-5">
              <div className="inline-flex items-center gap-2 bg-teal-50 dark:bg-teal-950 text-teal-700 dark:text-teal-300 text-xs font-bold px-3 py-1.5 rounded-full w-fit border border-teal-100 dark:border-teal-800">
              ...
              <div>
                ...
                <p className="text-lg text-teal-600 dark:text-teal-400 font-semibold mt-2">{doctorProfile.title}</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-1">
                ...
                <button
                  onClick={onViewDoctorProfile}
                  className="flex items-center justify-center gap-2 border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-600 text-slate-600 dark:text-slate-300 hover:text-teal-700 dark:hover:text-teal-400 font-semibold px-6 py-3 rounded-xl transition-all hover:bg-teal-50/50 dark:hover:bg-teal-950/50 text-sm"
                >
                  Ver perfil completo
            ...
            <div className="relative flex justify-center md:justify-end">
              <div className="relative w-60 h-72 sm:w-72 sm:h-88 md:w-72 md:h-[360px] lg:w-80 lg:h-[400px]">
                <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-teal-400 to-teal-700">
                  {!imgError && (
                    <img
                ...
                <div className="absolute -top-3 -right-2 sm:-right-5 bg-white dark:bg-slate-800 rounded-2xl shadow-xl px-3.5 py-2.5 border border-slate-100 dark:border-slate-700 z-20">
                  <p className="text-[10px] font-bold text-teal-600 dark:text-teal-400 uppercase tracking-wider">Cédula Prof.</p>
      ...
      <section className="py-16 md:py-24 bg-slate-50 dark:bg-slate-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <p className="text-[11px] font-bold text-teal-600 dark:text-teal-400 uppercase tracking-widest mb-3">Especialidades</p>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-semibold text-sm transition-colors flex-shrink-0"
            >
          ...
          <div className="text-center mt-10">
            <button
              onClick={onBookAppointment}
              className="inline-flex items-center gap-2 border border-teal-200 dark:border-teal-800 text-teal-700 dark:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-950 font-semibold text-sm px-5 py-2.5 rounded-xl transition-colors"
            >
              <Calendar className="w-4 h-4" />
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <p className="text-[11px] font-bold text-teal-600 dark:text-teal-400 uppercase tracking-widest mb-3">Reseñas verificadas</p>
          ...
          <div className="text-center mt-10">
            <a
              ...
              className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium"
            >
      ...
      {/* ── BOTTOM CTA ─────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-teal-600 py-16 md:py-20">
        <div
        ...
        <div className="relative max-w-2xl mx-auto text-center px-4 sm:px-6">
          <p className="text-[11px] font-bold text-teal-200 uppercase tracking-widest mb-4">Agenda tu consulta</p>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
            ¿Listo para sentirte<br />mejor?
          </h2>
          <p className="text-teal-100 text-[15px] leading-relaxed mb-8">
            Primera consulta disponible esta semana. Atención especializada en el corazón de la Ciudad de México.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={onBookAppointment}
              className="flex items-center justify-center gap-2 bg-white text-teal-700 font-bold px-7 py-3.5 rounded-xl transition-all hover:bg-teal-50 hover:shadow-2xl active:scale-[0.98] text-sm"
            >
              <Calendar className="w-4 h-4" />
              Agendar Cita Ahora
            </button>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 border-2 border-teal-400/60 text-white font-semibold px-7 py-3.5 rounded-xl transition-all hover:bg-teal-700/50 text-sm"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-5 text-slate-500 text-xs">
              <a href={`tel:${contactInfo.phone}`} className="flex items-center gap-1.5 hover:text-teal-400 transition-colors">
                <Phone className="w-3 h-3" />
                {contactInfo.phone}
              </a>
              <a href={`mailto:${contactInfo.email}`} className="flex items-center gap-1.5 hover:text-teal-400 transition-colors">
