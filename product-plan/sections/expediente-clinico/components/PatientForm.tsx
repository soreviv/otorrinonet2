...
// Multi-section form for creating or editing a patient clinical record
...
// ─── Tag input (allergies, conditions) ───────────────────────────────────────
    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-3 py-2 bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-300 rounded-xl hover:bg-teal-200 dark:hover:bg-teal-900/60 transition-colors"
        >
...
type FormState = {
  ...
  // Diagnosis (simplified single entry)
  dxCode: string
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-3">
        ...
        <div className="flex items-center justify-end gap-3 pt-2 pb-6">
          ...
          <button
            type="submit"
            className="flex items-center gap-2 px-6 py-2.5 bg-teal-600 hover:bg-teal-700 active:bg-teal-800 text-white text-sm font-semibold rounded-xl transition-colors shadow-sm"
          >
