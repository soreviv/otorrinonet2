/**
 * AppShell — Main shell wrapper for Dr. Viveros ORL platform.
 *
 * Provides two variants:
 * - "patient": Public-facing top navigation for patients
 * - "staff": Collapsible sidebar for medical staff (médico, enfermera, recepcionista)
 */
